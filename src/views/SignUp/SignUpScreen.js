            ...
            <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
                <View style={styles.container}>
                    ...
                    <Animatable.View animation="fadeInUp" style={styles.inputContainer}>
                        ...
                        {errors.inputSchool && <Text style={styles.error}>{errors.inputSchool}</Text>}
                        ...
                        <TextInput
                            ...
                            value={inputName}
                        />
                        {errors.inputName && <Text style={styles.error}>{errors.inputName}</Text>}
                        ...
                        <TextInput
                            ...
                            secureTextEntry
                        />
                        {errors.inputPassword && <Text style={styles.error}>{errors.inputPassword}</Text>}

                        {showPerfect && (
                            <Animatable.Text animation="fadeIn" duration={500} style={styles.success}>
